...
/**
 * This interface provides methods to manage <code>ViewType</code> entries within an easyrec database.
 * <p/>
 * <p><b>Company:&nbsp;</b>
 ...
 * @author Roman Cerny
 */
public interface ViewTypeDAO extends TableCreatingDAO {
    // constants
    public final static String DEFAULT_TABLE_NAME = "viewtype";
    ...
    public final static String VIEWTYPE_ADMIN = "ADMIN";
    public final static String VIEWTYPE_COMMUNITY = "COMMUNITY";
    public final static String VIEWTYPE_SYSTEM = "SYSTEM";

    // methods
    public int insertOrUpdate(Integer tenantId, String viewType, Integer id);
