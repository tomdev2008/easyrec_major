...
/**
 * This interface provides methods to manage <code>AggregateType</code> entries within an easyrec database.
 * <p/>
 * <p><b>Company:&nbsp;</b>
 ...
 * @author Roman Cerny
 */
public interface AggregateTypeDAO extends TableCreatingDAO {
    // constants
    public final static String DEFAULT_TABLE_NAME = "aggregatetype";
