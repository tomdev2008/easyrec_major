 ...
 * @author Roman Cerny
 */
public interface TypedActionDAO extends
        BaseActionDAO<ActionVO<Integer, String>, RankedItemVO<Integer, String>, String, String, ItemVO<Integer, String>, RatingVO<Integer, String>, Integer, Integer> {
