...
@DAO
public class SourceTypeDAOMysqlImpl extends AbstractTableCreatingDAOImpl implements SourceTypeDAO {
    // constants
    private final static String TABLE_CREATING_SQL_SCRIPT_NAME = "classpath:sql/core/types/SourceType.sql";

    // constructor 
    public SourceTypeDAOMysqlImpl(DataSource dataSource, SqlScriptService sqlScriptService) {
    ...
    // interface 'SourceTypeDAO' implementation
    @LongCacheable
    public String getTypeById(Integer tenantId, final Integer id) {
        ...
        ResultSetExtractor<String> rse = new ResultSetExtractor<String>() {
            public String extractData(ResultSet rs) {
                ...
                throw new IllegalArgumentException("unknown id: '" + id + "' for source type");
            }
        };
    ...
    public Integer getIdOfType(Integer tenantId, final String sourceType) {
        ...
        Object[] args = {tenantId, sourceType};
    ...
    public int insertOrUpdate(Integer tenantId, String sourceType, Integer id) {
        ...
        if (sourceType == null) {
            throw new IllegalArgumentException("missing constraints: missing 'sourceType'");
        }
        if (id == null) {
        ...
        boolean update;
        if (!existsType(tenantId, sourceType)) {
        ...
        if (update) {
            ...
            query.append(DEFAULT_NAME_COLUMN_NAME);
            query.append("=?");
            args = new Object[]{tenantId, sourceType, id, tenantId, sourceType};
            argTypes = new int[]{Types.INTEGER, Types.VARCHAR, Types.INTEGER, Types.INTEGER, Types.VARCHAR};
        } else {
            args = new Object[]{tenantId, sourceType, id};
    ...
    public int insertOrUpdate(Integer tenantId, String sourceType) {
        int newId = getMaxSourceTypeId(tenantId) + 1;
        insertOrUpdate(tenantId, sourceType, newId);
        return newId;
    }
    ...
    private int getMaxSourceTypeId(Integer tenantId) {
        // validate
        if (tenantId == null) {
            throw new IllegalArgumentException("missing constraints: missing 'tenantId'");
        }
    ...
    ///////////////////////////////////////////////////////////////////
    // private methods
    private boolean existsType(Integer tenantId, String sourceType) {
        Integer id;
        try {
