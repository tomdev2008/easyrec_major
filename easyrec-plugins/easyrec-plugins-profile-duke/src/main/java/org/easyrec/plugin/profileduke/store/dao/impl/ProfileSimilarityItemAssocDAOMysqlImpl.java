 ...
 */
package org.easyrec.plugin.profileduke.store.dao.impl;
 ...
 */
public class ProfileSimilarityItemAssocDAOMysqlImpl
        extends ItemAssocDAOMysqlImpl
        implements ProfileSimilarityItemAssocDAO {

    // logging
    private final Log logger = LogFactory.getLog(this.getClass());

    public ProfileSimilarityItemAssocDAOMysqlImpl(DataSource dataSource, SqlScriptService sqlScriptService) {
