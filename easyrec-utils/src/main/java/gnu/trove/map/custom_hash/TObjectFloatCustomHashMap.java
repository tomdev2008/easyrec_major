...
public class TObjectFloatCustomHashMap<K> extends TCustomObjectHash<K>
     ...
     */
    public TObjectFloatCustomHashMap( HashingStrategy<K> strategy ) {
        super( strategy );
    }
     ...
     */
    public TObjectFloatCustomHashMap( HashingStrategy<K> strategy, int initialCapacity ) {
     ...
     */
    public TObjectFloatCustomHashMap( HashingStrategy<K> strategy, int initialCapacity,
		float loadFactor, float noEntryValue ) {
    ...
    /** {@inheritDoc} */
    public void putAll( TObjectFloatMap<K> map ){
