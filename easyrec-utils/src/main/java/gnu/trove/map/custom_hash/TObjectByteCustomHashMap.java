...
public class TObjectByteCustomHashMap<K> extends TCustomObjectHash<K>
     ...
     */
    public TObjectByteCustomHashMap( HashingStrategy<K> strategy ) {
        super( strategy );
    }
     ...
     */
    public TObjectByteCustomHashMap( HashingStrategy<K> strategy, int initialCapacity ) {
     ...
     */
    public TObjectByteCustomHashMap( HashingStrategy<K> strategy, int initialCapacity,
		float loadFactor, byte noEntryValue ) {
     ...
     */
    public TObjectByteCustomHashMap( HashingStrategy<K> strategy, TObjectByteMap<K> map ) {
    ...
    /** {@inheritDoc} */
    public void putAll( TObjectByteMap<K> map ){
