...
public class TObjectDoubleCustomHashMap<K> extends TCustomObjectHash<K>
    ...
    private static final Log logger = LogFactory.getLog(TObjectDoubleCustomHashMap.class);
     ...
     */
    public TObjectDoubleCustomHashMap( HashingStrategy<K> strategy ) {
        super( strategy );
    }
     ...
     */
    public TObjectDoubleCustomHashMap( HashingStrategy<K> strategy, int initialCapacity ) {
     ...
     */
    public TObjectDoubleCustomHashMap( HashingStrategy<K> strategy, int initialCapacity,
		float loadFactor, double noEntryValue ) {
